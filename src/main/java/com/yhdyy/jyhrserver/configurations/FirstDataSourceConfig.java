...
@Configuration
@MapperScan(basePackages = "com.yhdyy.jyhrserver.daos.chisdb",sqlSessionTemplateRef ="firstSqlSessionTemplate")
public class FirstDataSourceConfig {
    ...
    /**本数据源扫描的mapper路径*/
    static final String MAPPER_LOCATION = "classpath:/com/yhdyy/jyhrserver/daos/chisdb/*.xml";
