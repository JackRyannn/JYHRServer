package com.yhdyy.jyhrserver.configurations;
...
@Configuration
@MapperScan(basePackages = "com.yhdyy.jyhrserver.daos.clabdb",sqlSessionTemplateRef ="secondSqlSessionTemplate")
public class SecondDataSourceConfig {
    ...
    /**本数据源扫描的mapper路径*/
    static final String MAPPER_LOCATION = "classpath:/com/yhdyy/jyhrserver/daos/clabdb/*.xml";
